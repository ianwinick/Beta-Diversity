...
# diversity values for the 2023 community data (year 4 after fire)             #
################################################################################

# See bootstrap_beta_2020 for code comments

data <- read_csv("CommunityMatrix_2023.csv")
...
bootU <- data.frame("year"=4, "boot"=1:999, "type"="tax", "severity"="U", "beta"=betaBoot)
...
bootL <- data.frame("year"=4, "boot"=1:999, "type"="tax", "severity"="L", "beta"=betaBoot)
...
bootH <- data.frame("year"=4, "boot"=1:999, "type"="tax", "severity"="H", "beta"=betaBoot)
...
Q_bootU <- data.frame("year"=4, "boot"=1:999, "type"="fun", "severity"="U", "beta"=Qboot)
...
Q_bootL <- data.frame("year"=4, "boot"=1:999, "type"="fun", "severity"="L", "beta"=Qboot)
...
Q_bootH <- data.frame("year"=4, "boot"=1:999, "type"="fun", "severity"="H", "beta"=Qboot)
...
write.csv(bootstrap, "Bootstrap Observed Beta Values/bootstrap_2023.csv", row.names=FALSE)
